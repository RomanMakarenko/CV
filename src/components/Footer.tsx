    ...
    <section id="contact" className="section-container">
      ...
      >
        <div className="relative mb-6">
          <div className="flex h-28 w-28 items-center justify-center overflow-hidden rounded-full border-2 border-accent/30 bg-accent/10">
            <span className="text-4xl font-bold text-accent">
              {ABOUT_ME.firstName.charAt(0)}
              {ABOUT_ME.lastName.charAt(0)}
            </span>
          </div>
