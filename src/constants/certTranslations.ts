...
export const CERT_CONTENT: Record<string, { en: string; uk: string }> = {
  ...
  "cc.cert-15.m0.name": { en: "Section 1: AI Testing Fundamentals: Thinking Beyond Traditional QA", uk: "Розділ AI Testing Fundamentals: Thinking Beyond Traditional QA" },
  "cc.cert-15.m0.l0.title": { en: "5 lectures · 24 min", uk: "5 lectures · 24 min" },
  "cc.cert-15.m0.l0.t0": { en: "1. Welcome to the Course - What this course is about?", uk: "1. Welcome to the Course - What this course is about?" },
  "cc.cert-15.m0.l0.t1": { en: "2. What exactly is Testing AI? How different it is from Traditional testing", uk: "2. What exactly is Testing AI? How different it is from Traditional testing" },
  "cc.cert-15.m0.l0.t2": { en: "3. How to validate non Deterministic output AI Systems - Shift in testing mindset", uk: "3. How to validate non Deterministic output AI Systems - Shift in testing mindset" },
  "cc.cert-15.m0.l0.t3": { en: "4. Introduction to DeepEval and its core capabilities for evaluating AI Systems", uk: "4. Introduction to DeepEval and its core capabilities for evaluating AI Systems" },
  "cc.cert-15.m0.l0.t4": { en: "Quiz 1: Quiz - Test your knowledge", uk: "Quiz 1: Quiz - Test your knowledge" },
  "cc.cert-15.m1.name": { en: "Section 2: DeepEval Setup & Building Your First AI Testing Project", uk: "Розділ DeepEval Setup & Building Your First AI Testing Project" },
  "cc.cert-15.m1.l0.title": { en: "4 lectures · 30 min", uk: "4 lectures · 30 min" },
  "cc.cert-15.m1.l0.t0": { en: "5. Download Dev and Testing Project codebase discussed in this course", uk: "5. Download Dev and Testing Project codebase discussed in this course" },
  "cc.cert-15.m1.l0.t1": { en: "6. Install PyCharm and configure AI Agents Project with necessary packages install", uk: "6. Install PyCharm and configure AI Agents Project with necessary packages install" },
  "cc.cert-15.m1.l0.t2": { en: "7. Understand the Demo of one of the AI Agents Project used for Testing", uk: "7. Understand the Demo of one of the AI Agents Project used for Testing" },
  "cc.cert-15.m1.l0.t3": { en: "8. Setup the LLM Keys to make Agents work - Claude & OpenAI", uk: "8. Setup the LLM Keys to make Agents work - Claude & OpenAI" },
  ...
  "cc.cert-15.m2.name": { en: "Section 3: Evaluating AI Agents with DeepEval Metrics & Golden Datasets", uk: "Розділ Evaluating AI Agents with DeepEval Metrics & Golden Datasets" },
  "cc.cert-15.m2.l0.title": { en: "6 lectures · 1 hr 7 min", uk: "6 lectures · 1 hr 7 min" },
  "cc.cert-15.m2.l0.t0": { en: "9. DeepEvals TaskCompletion Metric to evaluate the AI Agent - Blackbox Testing", uk: "9. DeepEvals TaskCompletion Metric to evaluate the AI Agent - Blackbox Testing" },
  "cc.cert-15.m2.l0.t1": { en: "10. Understand reading the result reports from Confident AI - Deep evals Integration", uk: "10. Understand reading the result reports from Confident AI - Deep evals Integration" },
  "cc.cert-15.m2.l0.t2": { en: "11. Important Notes", uk: "11. Important Notes" },
  "cc.cert-15.m2.l0.t3": { en: "12. Agents Component Testing overview - Understand internal workflow", uk: "12. Agents Component Testing overview - Understand internal workflow" },
  "cc.cert-15.m2.l0.t4": { en: "13. Goldens - Data sets to evaluate AI Systems and Importance to evals_Iterator", uk: "13. Goldens - Data sets to evaluate AI Systems and Importance to evals_Iterator" },
  "cc.cert-15.m2.l0.t5": { en: "14. Implement Tracing with in Test file for smart Agent calling & track workflow", uk: "14. Implement Tracing with in Test file for smart Agent calling & track workflow" },
  "cc.cert-15.m3.name": { en: "Section 4: Testing AI Agent Internals: Traces, Components & Root Cause Analysis", uk: "Розділ Testing AI Agent Internals: Traces, Components & Root Cause Analysis" },
  "cc.cert-15.m3.l0.title": { en: "3 lectures · 42 min", uk: "3 lectures · 42 min" },
  "cc.cert-15.m3.l0.t0": { en: "15. When to use Component test Tracing type ? & When to go for LLMTestCase style", uk: "15. When to use Component test Tracing type ? & When to go for LLMTestCase style" },
  "cc.cert-15.m3.l0.t1": { en: "16. Understand how DeepEvals reports fail reason if AI Agents are not up to quality", uk: "16. Understand how DeepEvals reports fail reason if AI Agents are not up to quality" },
  "cc.cert-15.m3.l0.t2": { en: "17. Another Metric example in Component/Trace level to test AI Agents internal flow", uk: "17. Another Metric example in Component/Trace level to test AI Agents internal flow" },
  "cc.cert-15.m4.name": { en: "Section 5: ⚙️ Building Custom AI Evaluation Metrics with G-Eval", uk: "Розділ ⚙️ Building Custom AI Evaluation Metrics with G-Eval" },
  "cc.cert-15.m4.l0.title": { en: "4 lectures · 30 min", uk: "4 lectures · 30 min" },
  "cc.cert-15.m4.l0.t0": { en: "18. How to build Custom Metrics with DeepEvals - Intro to GEval Class", uk: "18. How to build Custom Metrics with DeepEvals - Intro to GEval Class" },
  "cc.cert-15.m4.l0.t1": { en: "19. Merge multiple Metrics into Single Test file with end to end Agent Testing", uk: "19. Merge multiple Metrics into Single Test file with end to end Agent Testing" },
  "cc.cert-15.m4.l0.t2": { en: "20. Demo of building custom Faithfulness Metric using Geval to evaluate the Agents", uk: "20. Demo of building custom Faithfulness Metric using Geval to evaluate the Agents" },
  "cc.cert-15.m4.l0.t3": { en: "Quiz 2: Quiz - Check your knowledge", uk: "Quiz 2: Quiz - Check your knowledge" },
  "cc.cert-15.m5.name": { en: "Section 6: Testing Multi-Turn Chatbots & Conversational AI Systems", uk: "Розділ Testing Multi-Turn Chatbots & Conversational AI Systems" },
  "cc.cert-15.m5.l0.title": { en: "6 lectures · 43 min", uk: "6 lectures · 43 min" },
  "cc.cert-15.m5.l0.t0": { en: "21. How to validate Multi Turn AI conversations such as Chatbot etc? - Overview", uk: "21. How to validate Multi Turn AI conversations such as Chatbot etc? - Overview" },
  "cc.cert-15.m5.l0.t1": { en: "22. Build Turns list object to track conversations and evaluate the Chatbot Metrics", uk: "22. Build Turns list object to track conversations and evaluate the Chatbot Metrics" },
  "cc.cert-15.m5.l0.t2": { en: "23. End to end demo of Multi conversational Agents validation with Deep evals", uk: "23. End to end demo of Multi conversational Agents validation with Deep evals" },
  "cc.cert-15.m5.l0.t3": { en: "24. Explore other Standard Deep evals Metrics to test Chatbot similar AI Apps", uk: "24. Explore other Standard Deep evals Metrics to test Chatbot similar AI Apps" },
  "cc.cert-15.m5.l0.t4": { en: "25. Build Custom Metrics to validate Chatbot AI Systems using GEval - Example demo", uk: "25. Build Custom Metrics to validate Chatbot AI Systems using GEval - Example demo" },
  "cc.cert-15.m5.l0.t5": { en: "Quiz 3: Quiz - Test your knowledge", uk: "Quiz 3: Quiz - Test your knowledge" },
  "cc.cert-15.m6.name": { en: "Section 7: Testing RAG Applications: Retrieval Quality & Response Accuracy", uk: "Розділ Testing RAG Applications: Retrieval Quality & Response Accuracy" },
  "cc.cert-15.m6.l0.title": { en: "6 lectures · 1 hr 10 min", uk: "6 lectures · 1 hr 10 min" },
  "cc.cert-15.m6.l0.t0": { en: "26. What are RAG Agents? How different they are from Traditional AI Agents?", uk: "26. What are RAG Agents? How different they are from Traditional AI Agents?" },
  "cc.cert-15.m6.l0.t1": { en: "27. Get demo of RAG App used for testing & compare it with AI Agent demo app", uk: "27. Get demo of RAG App used for testing & compare it with AI Agent demo app" },
  "cc.cert-15.m6.l0.t2": { en: "28. RAG Metrics - Contextual Precision Metric to validate RAG Agent output quality", uk: "28. RAG Metrics - Contextual Precision Metric to validate RAG Agent output quality" },
  "cc.cert-15.m6.l0.t3": { en: "29. Demo example of validating RAG Agents with standard Deep eval Metric methods", uk: "29. Demo example of validating RAG Agents with standard Deep eval Metric methods" },
  "cc.cert-15.m6.l0.t4": { en: "30. RAG Metrics - Contextual Recall Metric to validate RAG Agent retrieval quality", uk: "30. RAG Metrics - Contextual Recall Metric to validate RAG Agent retrieval quality" },
  "cc.cert-15.m6.l0.t5": { en: "Quiz 4: Quiz - Test your knowledge", uk: "Quiz 4: Quiz - Test your knowledge" },
  "cc.cert-15.m7.name": { en: "Section 8: Synthetic Data Generation & AI Safety Testing", uk: "Розділ Synthetic Data Generation & AI Safety Testing" },
  "cc.cert-15.m7.l0.title": { en: "5 lectures · 33 min", uk: "5 lectures · 33 min" },
  "cc.cert-15.m7.l0.t0": { en: "31. What is Synthetic Data Generation and how it helps to generate goldens", uk: "31. What is Synthetic Data Generation and how it helps to generate goldens" },
  "cc.cert-15.m7.l0.t1": { en: "32. Demo example of Data Generation technique implementation in Deep Evals Tests", uk: "32. Demo example of Data Generation technique implementation in Deep Evals Tests" },
  "cc.cert-15.m7.l0.t2": { en: "33. Deep Evals Safety Metrics demonstration with data generation capability", uk: "33. Deep Evals Safety Metrics demonstration with data generation capability" },
  "cc.cert-15.m7.l0.t3": { en: "34. Wrap up - What did we learn from this course? Next steps", uk: "34. Wrap up - What did we learn from this course? Next steps" },
  "cc.cert-15.m7.l0.t4": { en: "35. Resume skills what you can add from from this course", uk: "35. Resume skills what you can add from from this course" },
  "cc.cert-15.m8.name": { en: "Section 9: Final Exam - Assess your knowledge", uk: "Розділ Final Exam - Assess your knowledge" },
  "cc.cert-15.m8.l0.title": { en: "2 lectures · 1 min", uk: "2 lectures · 1 min" },
  "cc.cert-15.m8.l0.t0": { en: "Quiz 5: Quiz - MCQ's", uk: "Quiz 5: Quiz - MCQ's" },
  "cc.cert-15.m8.l0.t1": { en: "36. AI Testing Interview Questions download", uk: "36. AI Testing Interview Questions download" },
  "cc.cert-15.m9.name": { en: "Section 10: Optional - Learn Python Fundamentals with examples", uk: "Розділ Optional - Learn Python Fundamentals with examples" },
  "cc.cert-15.m9.l0.title": { en: "14 lectures · 2 hr 4 min", uk: "14 lectures · 2 hr 4 min" },
  "cc.cert-15.m9.l0.t0": { en: "37. Python hello world Program with Basics", uk: "37. Python hello world Program with Basics" },
  "cc.cert-15.m9.l0.t1": { en: "38. Datatypes in python and how to get the Type at run time", uk: "38. Datatypes in python and how to get the Type at run time" },
  "cc.cert-15.m9.l0.t2": { en: "39. List Datatype and its operations to manipulate", uk: "39. List Datatype and its operations to manipulate" },
  "cc.cert-15.m9.l0.t3": { en: "40. Tuple and Dictionary Data types in Python with examples", uk: "40. Tuple and Dictionary Data types in Python with examples" },
  "cc.cert-15.m9.l0.t4": { en: "41. If else condition in python with working examples", uk: "41. If else condition in python with working examples" },
  "cc.cert-15.m9.l0.t5": { en: "42. How to Create Dictionaries at run time and add data into it", uk: "42. How to Create Dictionaries at run time and add data into it" },
  "cc.cert-15.m9.l0.t6": { en: "43. How loops work in Python and importance of code idendation", uk: "43. How loops work in Python and importance of code idendation" },
  "cc.cert-15.m9.l0.t7": { en: "44. Programming examples using for loop - 1", uk: "44. Programming examples using for loop - 1" },
  "cc.cert-15.m9.l0.t8": { en: "45. Programming examples using While loop - 2", uk: "45. Programming examples using While loop - 2" },
  "cc.cert-15.m9.l0.t9": { en: "46. What are functions? How to use them in Python", uk: "46. What are functions? How to use them in Python" },
  "cc.cert-15.m9.l0.t10": { en: "47. OOPS Principles : Classes and objects in Python", uk: "47. OOPS Principles : Classes and objects in Python" },
  "cc.cert-15.m9.l0.t11": { en: "48. What is Constructor and its role in Object oriented programming", uk: "48. What is Constructor and its role in Object oriented programming" },
  "cc.cert-15.m9.l0.t12": { en: "49. Inheritance concepts with examples in Python", uk: "49. Inheritance concepts with examples in Python" },
  "cc.cert-15.m9.l0.t13": { en: "50. Strings and its functions in python", uk: "50. Strings and its functions in python" },
  "cc.cert-15.m10.name": { en: "Section 11: Bonus Lecture", uk: "Розділ Bonus Lecture" },
  "cc.cert-15.m10.l0.title": { en: "1 lecture · 1 min", uk: "1 lecture · 1 min" },
  "cc.cert-15.m10.l0.t0": { en: "51. Bonus Lecture", uk: "51. Bonus Lecture" },
};
