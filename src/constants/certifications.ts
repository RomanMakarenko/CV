...
export const CERTIFICATIONS: Certification[] = [
  {
    ...
    issuer: "Udemy",
    date: "Aug 2026",
    image: "/certificates/UC-ac916a9e-2bd1-49b1-ba0e-0464c6a8d93d.jpg",
    description:
      "A 41-hour practical QA course covering web and mobile testing, API testing with Postman, SQL, test documentation, traffic analysis, CI/CD, and AI-assisted testing.",
    modules: [
      {
        name: "Section 1: Бесплатные плюшки :)",
        levels: [{
          title: "3 course items",
          topics: ["1. Моя обучающая платформа с курсами, которых нет на Udemy – learn.rusau.net", "2. Как стать тестировщиком? Дорожная карта", "3. Рабочий день тестировщика. Что мы изучим на курсе?"],
        }],
      },
      {
        name: "Section 2: ИИ-помощники и дополнительные материалы",
        levels: [{
          title: "6 course items",
          topics: ["4. Рабочая тетрадь", "5. Шпаргалки", "6. Уникальная функция курса: 60 ИИ-задач", "7. ИИ-помощник: умная база знаний", "8. ИИ-помощник: генератор тестов по материалам курса", "9. ИИ-помощник: проверка основных заданий с обратной связью"],
        }],
      },
      {
        name: "Section 3: Теория тестирования",
        levels: [{
          title: "36 course items",
          topics: ["10. Перед началом курса + ссылка на Telegram-сообщество", "11. О модуле \"Теория тестирования\"", "12. QA, QC, Testing", "13. QA, QC, Testing. Конспект", "14. Верификация и валидация", "15. Верификация и валидация. Конспект", "Quiz 1: Понятия QA, QC и Testing. Тест", "16. Принципы тестирования", "17. Принципы тестирования. Конспект", "Quiz 2: Принципы тестирования ПО. Тест", "18. SDLC. Модели разработки", "19. SDLC и STLC. Конспект", "20. Модели разработки. Конспект", "Quiz 3: Модели разработки ПО. Тест", "21. Уровни тестирования", "22. Уровни тестирования. Конспект", "Quiz 4: Уровни тестирования. Тест", "23. Типы тестирования", "24. Типы тестирования. Конспект", "Quiz 5: Тестирование, связанное с изменениями. Тест", "Assignment 1: Регрессионный набор", "25. Решение: регрессионный набор", "Quiz 6: Функциональное и нефункциональное тестирование. Тест", "Assignment 2: Определяем методы, типы и уровни тестирования", "26. Решение: Определяем методы, типы и уровни тестирования", "27. Scrum", "28. Scrum. Конспект", "Quiz 7: Agile и Scrum. Тест", "29. Kanban и XP", "30. Kanban и XP. Конспект", "31. Анализ требований", "32. Анализ требований. Конспект", "Quiz 8: Анализ требований. Тест", "Assignment 3: Анализ требований и макета", "33. Решение: Анализ требований и макета", "Role Play 1: Имитация собеседования по теме \"Теория тестирования\" Role Play"],
        }],
      },
      {
        name: "Section 4: Техники тест-дизайна",
        levels: [{
          title: "15 course items",
          topics: ["34. О модуле \"Техники тест-дизайна\"", "35. Классы эквивалентности и граничные значения", "36. Классы эквивалентности и граничные значения. Конспект", "Quiz 9: Классы эквивалентности и граничные значения. Тест", "Assignment 4: Тестирование формы регистрации", "37. Решение: Тестирование формы регистрации", "38. Попарное тестирование", "39. Попарное тестирование. Конспект", "Quiz 10: Попарное тестирование", "Assignment 5: Тестирование фильтрации и сортировки", "40. Решение: Тестирование фильтрации и сортировки", "41. Диаграмма переходов и состояний, таблица принятия решений", "42. Диаграмма переходов и состояний, таблица принятия решений. Конспект", "Quiz 11: Диаграмма переходов и состояний, таблица принятия решений, предугадывание ошибок", "Role Play 2: Имитация собеседование по теме \"Тест-дизайн\" Role Play"],
        }],
      },
      {
        name: "Section 5: Тестовая документация",
        levels: [{
          title: "36 course items",
          topics: ["43. О модуле \"Тестовая документация\"", "44. Тест-план, тест-стратегия", "45. Тест-план, тест-стратегия. Конспект", "46. Отчет о результатах тестирования", "47. Отчет о результатах тестирования. Конспект", "Quiz 12: Тест-план, тест-стратегия и отчет по результатам тестирования", "48. Чек-листы", "49. Чек-листы. Конспект", "Assignment 6: Создаем чек-лист для тестирования регистрации и логина", "50. Решение: Создаем чек-лист для тестирования регистрации и логина", "51. Тест-кейсы", "52. Тест-кейсы. Конспект", "Assignment 7: Создаем тест-кейсы на основании проверок из чек-листа для регистрации и логина", "53. Решение: Создаем тест-кейсы на основании проверок из чек-листа для регистрации и", "Quiz 13: Тест-кейсы и чек-листы", "54. Qase. Обзор функций", "55. TestIT. Обзор функций", "56. Работа в TestRail", "57. Отчет о дефекте. ЖЦ дефекта. Улучшения.", "58. Отчет о дефекте. ЖЦ дефекта. Улучшения. Конспект", "Quiz 14: Отчет о дефекте. ЖЦ дефекта. Улучшения.", "Quiz 15: Ошибки, дефекты, сбои, отказы и улучшения", "59. JQL в Jira", "Quiz 16: JQL в Jira", "60. Работа в Jira", "61. Youtrack 2025. Обзор функций", "Assignment 8: Создаем отчеты о дефекте для регистрации и логина", "62. Решение: Создаем отчеты о дефекте для регистрации и логина", "63. Матрица трассировки и метрики в тестировании", "64. Матрица трассировки. Конспект", "Quiz 17: Матрица трассировки и метрики в тестировании", "65. Оценка трудозатрат в тестировании. Виды эстимации", "66. Оценка трудозатрат в тестировании. Виды эстимации. Конспект", "Quiz 18: Оценка трудозатрат в тестировании. Тест", "67. Общая презентация по частям 2, 3, 4", "Role Play 3: Имитация собеседования по теме \"Тестовая документация\" Role Play"],
        }],
      },
      {
        name: "Section 6: Тестирование веб-приложений",
        levels: [{
          title: "32 course items",
          topics: ["68. О модуле \"Тестирование веб-приложений\"", "69. Как работает Internet? IP, MAC, URL, DNS", "70. Как работает Internet? IP, MAC, URL, DNS. Конспект", "Quiz 19: Как работает Internet? IP, MAC, URL, DNS", "71. Клиент-серверная архитектура. Монолиты и микросервисы. Балансировщики", "72. Клиент-серверная архитектура. Конспект", "Quiz 20: Клиент-серверная архитектура. Монолиты и микросервисы. Балансировщики", "73. HTTP-протокол. HTTP-методы. Запросы и ответы. Коды ответов", "74. HTTP-протокол. Конспект", "Quiz 21: HTTP-протокол. HTTP-методы. Запросы и ответы. Коды ответов", "75. Кэш и куки. Разница в определениях веб-сайта, приложения, сервиса и сервера", "76. Кэш и куки. Конспект", "77. Разница в определениях веб-сайта, приложения, сервиса и сервера. Конспект", "Quiz 22: Кэш и куки. Разница в определениях веб-сайта, приложения, сервиса и сервера", "78. Chrome DevTools. Инструменты разработчика в браузере", "Quiz 23: Chrome DevTools. Инструменты разработчика в браузере", "79. Chrome DevTools. Конспект", "Assignment 9: Работа в DevTools", "80. Основы HTML и CSS", "81. Основы HTML и CSS. Конспект", "Quiz 24: Основы HTML и CSS", "Assignment 10: Создание простой веб-страницы", "82. Виды UI. Верстка", "83. Виды UI. Верстка. Конспект", "84. Тестирование веб-элементов", "85. Тестирование веб-форм", "86. Figma + примеры для тестирования веб-форм и элементов. Конспект", "Quiz 25: Тестирование веб-форм и полей ввода", "87. Обзор клиентской части учебного приложения", "Assignment 11: Поиск багов в корзине", "88. Решение: Список багов", "Role Play 4: Имитация собеседования по теме \"Тестирование веб-приложений\" Role Play"],
        }],
      },
      {
        name: "Section 7: Тестирование API с помощью Postman",
        levels: [{
          title: "32 course items",
          topics: ["89. Виды API. SOAP и REST", "Quiz 26: Виды API. SOAP и REST", "90. Виды API. SOAP и REST. Конспект", "Assignment 12: Проверяем XML на ошибки", "91. Решение: Проверяем XML на ошибки", "Quiz 27: Виды интерфейсов. Тест", "92. Установка Postman 2026 и самые важные функции", "93. Postman. Обзор функций 2023", "94. Postman. Обзор функций 2022", "Quiz 28: Установка и обзор Postman", "Quiz 29: Переменные и окружения", "Quiz 30: Postman. Обзор функций", "95. API-документация. Swagger и типы данных", "Quiz 31: API-документация. Swagger и типы данных", "96. Что такое cURL?", "97. HTTP-методы. Цепочка запросов", "Quiz 32: HTTP-методы. Цепочка запросов", "98. Идентификация, аутентификация и авторизация. Типы авторизации в Postman", "99. Токен авторизации", "Quiz 33: Идентификация, аутентификация и авторизация. Типы авторизации в Postman", "100. Обзор серверной части учебного приложения", "101. Перехват трафика в Postman", "Quiz 34: Перехват трафика в Postman", "102. Тест-кейсы и простые авто-тесты", "Quiz 35: Простые автотесты", "103. Работа с тестовыми данными в Postman", "Assignment 13: Создаем первую коллекцию", "104. Решение: Создаем первую коллекцию", "105. Тестирование SOAP", "Quiz 36: Тестирование SOAP", "Assignment 14: Тестируем SOAP-сервис", "106. Решение: Тестируем SOAP-сервис"],
        }],
      },
      {
        name: "Section 8: Тестирование баз данных",
        levels: [{
          title: "23 course items",
          topics: ["107. Виды БД. Реляционная БД, нормализация, связи", "108. Виды БД. Реляционная БД, нормализация, связи. Конспект", "Quiz 37: Базы данных. Типы БД и СУБД. Нормальные формы", "109. Настройка MySQL. Операторы создания, изменения и удаления", "110. Операторы создания, изменения и удаления. Конспект", "Quiz 38: Установка MySQL-сервер. Создание таблиц в БД", "111. DBeaver", "112. Select в MySQL", "113. Select в MySQL. Конспект", "Quiz 39: SELECT запросы в SQL. Агрегатные функции", "Quiz 40: Импорт и экспорт БД. Null, UNION, HAVING", "Assignment 15: Отправляем SELECT-запросы", "114. Решение: Отправляем SELECT-запросы", "115. Join в MySQL", "116. Join в MySQL. Конспект", "Quiz 41: JOIN запросы в SQL", "Assignment 16: Отправляем JOIN-запросы", "117. Решение: Отправляем JOIN-запросы", "118. MongoDB. Установка и базовые запросы", "119. MongoDB. Базовые запросы. Конспект", "Quiz 42: MongoDB. Установка и базовые запросы", "Assignment 17: Создаем коллекцию в MongoDB", "120. Решение: Создаем коллекцию в MongoDB"],
        }],
      },
      {
        name: "Section 9: Тестирование мобильных приложений",
        levels: [{
          title: "19 course items",
          topics: ["121. Android и iOS. Особенности платформ", "122. Тестовая ферма", "123. Отличия Android и iOS. Тестовые фермы. Конспект", "Quiz 43: Android и iOS. Тестовая ферма", "124. Типы мобильных приложений", "125. Типы мобильных приложений. Конспект", "Quiz 44: Типы мобильных приложений", "126. Особенности тестирования мобильных приложений", "127. Особенности тестирования мобильных приложений. Конспект", "128. Типы тестирования в мобильных приложениях", "129. Типы тестирования в мобильных приложениях. Конспект", "Quiz 45: Особенности тестирования мобильных приложений", "130. Android Studio. Функции и логи", "Assignment 18: Создаем чек-лист и тест-кейсы для тестирования мобильных приложений", "131. Решение: Создаем чек-лист и тест-кейсы для тестирования мобильных приложений", "132. Xcode. Функции и логи", "Quiz 46: Android Studio и Xcode", "Assignment 19: Тестируем мобильное приложение", "133. Решение: Тестируем мобильное приложение"],
        }],
      },
      {
        name: "Section 10: Инструменты для перехвата и анализа трафика",
        levels: [{
          title: "13 course items",
          topics: ["134. Charles Proxy. Установка, настройка, обзор интерфейса", "135. Charles Proxy. Функции", "Quiz 47: Установка и настройка Charles Proxy", "Quiz 48: Использование Charles Proxy для тестирования", "136. Fiddler Everywhere. Установка, настройка, обзор интерфейса", "137. Fiddler Everywhere. Функции", "Quiz 49: Установка и настройка Fiddler", "Quiz 50: Использование Fiddler для тестирования", "138. Proxyman. Установка и настройка", "139. Proxyman. Функции", "Quiz 51: Proxyman. Установка и использование", "Assignment 20: Перехватываем и изменяем трафик", "140. Решение: Перехватываем и изменяем трафик"],
        }],
      },
      {
        name: "Section 11: Работа в git и bash",
        levels: [{
          title: "17 course items",
          topics: ["141. Работа с bash", "142. Работа с bash. Конспект", "Quiz 52: Установка и настройка подсиcтемы Linux на Windows", "Quiz 53: Команды ls и mkdir", "Quiz 54: Команды mv, cp, nano, less, vi, cat", "Quiz 55: Команды grep и find", "Quiz 56: Операции с выводом и процессами", "Quiz 57: Команды ping и curl", "143. Работа с git", "144. Работа с git. Конспект", "Quiz 58: Основы GIT", "Quiz 59: Установка и настройка git/github", "Quiz 60: Базовые команды git. Отслеживание изменений", "Quiz 61: git commit, git checkout", "Quiz 62: Работа с ветками в git", "145. Создание портфолио", "Assignment 21: Подготовка своего портфолио в GitHub"],
        }],
      },
      {
        name: "Section 12: Финальное тестирование",
        levels: [{
          title: "2 course items",
          topics: ["Practice Test 1: Итоговый тест. Часть 1", "Practice Test 2: Итоговый тест. Часть 2"],
        }],
      },
      {
        name: "Section 13: Дополнительно: CI/CD и ChatGPT",
        levels: [{
          title: "12 course items",
          topics: ["146. Тестовые окружения", "147. Тестовые окружения. Конспект", "148. CI/CD для тестировщика", "149. CI/CD для тестировщика. Конспект", "150. ChatGPT для тестировщика", "151. Jenkins. Установка", "152. Jenkins. Интерфейс", "153. Фристайл-проект в Jenkins", "154. Pipeline в Jenkins", "155. Параметризированная сборка в Jenkins", "156. Обзор рабочего проекта в Jenkins", "157. Github Actions"],
        }],
      },
      {
        name: "Section 14: Архивные домашние задания",
        levels: [{
          title: "17 course items",
          topics: ["Assignment 22: Анализ требований", "158. Решение: анализ требований", "Assignment 23: Задание на классы эквивалентности и граничные значения", "159. Решение: классы эквивалентности", "160. Важное уточнение перед выполнением домашнего задания", "Assignment 24: Написание тест-кейсов, чек-листов и отчетов о дефекте", "161. Решение: тестовая документация", "Assignment 25: Создание отчетов о дефекте", "162. Решение: Jira", "Assignment 26: Задание: создание коллекции", "163. Решение: создание коллекции", "Assignment 27: Итоговое задание к модулю \"Тестирование баз данных\"", "164. Решение: MySQL", "Assignment 28: Тестирование мобильного приложения", "165. Решение: тестирование мобильных приложений", "Assignment 29: Перехват трафика с помощью Charles Proxy", "166. Решение: перехват трафика с помощью Charles Proxy"],
        }],
      },
      {
        name: "Section 15: Дополнительно: Трудоустройство",
        levels: [{
          title: "4 course items",
          topics: ["167. Создание резюме", "168. Создание профиля в LinkeIIn", "169. Создание сопроводительного письма", "170. Bonus Lecture"],
        }],
      }
    ],
  },
